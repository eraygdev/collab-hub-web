...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!acceptTerms) {
      alert('Lütfen kullanım koşullarını kabul et.');
      return;
    }
  ...
  const handleGithub = () => {
    alert('GitHub ile kayıt yakında aktif olacak!');
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer select-none">
              ...
              <span className="text-xs text-gray-600 leading-relaxed">
                <Link to="#" className="text-black hover:underline">Kullanım Koşulları</Link>'nı ve{' '}
                <Link to="#" className="text-black hover:underline">Gizlilik Politikası</Link>'nı okudum, kabul ediyorum.
              </span>
            </label>
