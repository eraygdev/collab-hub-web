...
export default function CreateProject() {
  ...
  const overLimit = (key) => form[key].length > LIMITS[key];
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.title.length} max={LIMITS.title} id="title-counter" />
            </div>
            <input
              id="title"
              name="title"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.description.length} max={LIMITS.description} id="description-counter" />
            </div>
            <textarea
              id="description"
              name="description"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.longDescription.length} max={LIMITS.longDescription} id="long-description-counter" />
            </div>
            <textarea
              id="longDescription"
              ...
              rows={6}
              maxLength={LIMITS.longDescription}
              disabled={submitting}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.githubUrl.length} max={LIMITS.githubUrl} id="github-url-counter" />
            </div>
            <input
              id="githubUrl"
              name="githubUrl"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.demoUrl.length} max={LIMITS.demoUrl} id="demo-url-counter" />
            </div>
            <input
              id="demoUrl"
              name="demoUrl"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <CharCounter current={form.imageUrl.length} max={LIMITS.imageUrl} id="image-url-counter" />
            </div>
            <input
              id="imageUrl"
              name="imageUrl"
