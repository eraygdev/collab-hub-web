  ...
  return (
    <footer className="w-full relative">
      ...
      <div className="relative w-full bg-gray-900 text-white overflow-hidden">
        ...
        {/* ✅ YIRTIK KAĞIT EFEKTİ — sade, noktasız */}
        <svg
          className="absolute bottom-0 left-0 right-0 w-full h-24 text-gray-50"
          viewBox="0 0 1440 96"
        ...
        >
          <path d="
            M0,96
            L0,48 L25,44 L50,52 L75,38 L100,60 L125,42 L150,50 L180,36
            L210,62 L240,44 L270,54 L300,40 L330,58 L360,36 L390,50 L420,46
            L450,60 L480,38 L510,54 L540,44 L570,58 L600,38 L630,52 L660,44
            L690,62 L720,40 L750,52 L780,38 L810,58 L840,42 L870,60 L900,36
            L930,54 L960,44 L990,58 L1020,40 L1050,52 L1080,38 L1110,62 L1140,44
            L1170,56 L1200,40 L1230,54 L1260,42 L1290,60 L1320,44 L1350,52 L1380,36
            L1410,58 L1440,48
            L1440,96 Z
          " />
        </svg>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-white hover:bg-gray-900 hover:border-gray-900 transition-all"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 .5C5.73.5.5 5.73.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.56 0-.28-.01-1.02-.02-2-3.2.7-3.88-1.54-3.88-1.54-.52-1.33-1.28-1.68-1.28-1.68-1.05-.72.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.71 1.26 3.37.96.1-.75.4-1.26.73-1.55-2.55-.29-5.23-1.28-5.23-5.69 0-1.26.45-2.29 1.19-3.1-.12-.29-.52-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11.1 11.1 0 015.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.59.23 2.76.11 3.05.74.81 1.19 1.84 1.19 3.1 0 4.42-2.69 5.39-5.25 5.68.41.35.78 1.05.78 2.12 0 1.53-.01 2.76-.01 3.13 0 .31.21.67.8.56C20.21 21.39 23.5 17.08 23.5 12 23.5 5.73 18.27.5 12 .5z" />
                  </svg>
                ...
                <a
                  ...
                  aria-label="E-posta"
                  className="w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-white hover:bg-blue-500 hover:border-blue-500 transition-all"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Twitter"
                  className="w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-white hover:bg-black hover:border-black transition-all"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
